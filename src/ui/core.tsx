				...
				<ol className="list-inside list-decimal space-y-4 text-zinc-200">
					<li>
						...
						<p className="text-zinc-400">
							...
							<code>undefined</code>, you could end up with literal <code>undefined</code> in the class
							string. Default to
							an empty string.
						</p>
					...
					<li>
						...
						<p className="text-zinc-400">
							Typos like <code>{'<Button size="medium" />'}</code> silently fall back. Prefer
							TypeScript-enforced unions.
						</p>
						<CodeBlock
							code={`type ButtonSize = keyof typeof sizeClasses; // 'sm' | 'md' | 'lg' type ButtonVariant = keyof typeof variantClasses; // 'primary' | 'secondary' | 'outline'`}
						/>
					</li>
					...
					<li>
						...
						<p className="text-zinc-400">
							Later props can override earlier ones. Keep important defaults first and document intended
							usage.
						</p>
